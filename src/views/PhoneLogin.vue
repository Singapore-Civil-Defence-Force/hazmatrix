...
export default {
  ...
  data() {
    return {
      ...
      // Defaults to +65 singapore code since only expecting singaporean numbers to be used.
      // There is a space to make it more visually appealing, it will be stripped out in sendOtp logic
      phoneNumber: "+65 ",
      otp: undefined,
    };
  },
